...
#define UART4_ENABLE 0 // T5L serial port 4 open and close settings, 1 to open, 0 to close
#define UART5_ENABLE 0 // T5L serial port 5 open and close settings, 1 opens, 0 closes
