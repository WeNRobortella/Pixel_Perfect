...
$(OBJDIR)/ButtonConfig.rel: src/app/ButtonConfig/ButtonConfig.c
	@mkdir -p $(OBJDIR)
	$(SDCC) $(CFLAGS) -c $< -o $@

$(OBJDIR)/Controller.rel: src/app/Controller/Controller.c
	@mkdir -p $(OBJDIR)
	$(SDCC) $(CFLAGS) -c $< -o $@
...
$(OBJDIR)/MovementComponent.rel: src/app/MovementComponent/MovementComponent.c
	@mkdir -p $(OBJDIR)
	$(SDCC) $(CFLAGS) -c $< -o $@

$(OBJDIR)/PlayerCharacter.rel: src/app/PlayerCharacter/PlayerCharacter.c
	@mkdir -p $(OBJDIR)
	$(SDCC) $(CFLAGS) -c $< -o $@
